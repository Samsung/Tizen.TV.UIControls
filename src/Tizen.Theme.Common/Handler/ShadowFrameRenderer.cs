...
//using NLayoutEventArgs = Tizen.UIExtensions.Common.LayoutEventArgs;
...
//            _clipper = new SKClipperView();
//            _clipper.Show();
//            //_clipper.PassEvents = true;
//            _clipper.DrawClippingArea += OnCliperPaint;
...
//            _shadowCanvasView = new SKCanvasView();
